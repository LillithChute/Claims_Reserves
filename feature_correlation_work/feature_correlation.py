...
categorical_features = ['POLICY_NAICS_SECTOR', 'POLICY_NAICS_CODE', 'POLICY_GOVERNING_CLASS', 'CLAIM_TYPE',
                        'INJURY_CAUSE',
                        'BODY_PART', 'NATURE_OF_INJURY', 'CLASS_CODE', 'INJURY_STATE', 'JURISDICTION_STATE',
                        'OCCUPATION']
...
medical_correlation = associations(df, nominal_columns=categorical_features, filename='medical_all_correlation.png',
                                   title='Medical Only Correlation Matrix - 100k rows')
...
indemnity_correlation = associations(df, nominal_columns=categorical_features, filename='indemnity_all_correlation.png',
                                     title='Indemnity Correlation Matrix - 73k rows')
